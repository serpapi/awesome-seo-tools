...
- [SEO Blog Engine](https://github.com/Wittlesus/seo-blog-engine) - A Node.js CLI tool that generates SEO-optimized blog post templates with frontmatter, schema markup, and structured content across 4 formats (how-to, listicle, comparison, ultimate guide).
