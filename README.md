...
- [UnfoldCMS](https://unfoldcms.com) - Self-hosted CMS (Laravel + React) with built-in SEO tools: meta tags, XML sitemap, structured data, and SEO analytics. Supports headless mode with Next.js, Astro, SvelteKit, and Nuxt integrations.
