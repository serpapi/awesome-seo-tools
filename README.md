...
- [SEO Score API](https://seoscoreapi.com) - REST API for automated SEO audits. Returns a 0-100 score with 28 checks across meta, technical, social, performance, and accessibility. Free tier available. [GitHub Action](https://github.com/SeoScoreAPI/seo-audit-action) for CI/CD integration.
